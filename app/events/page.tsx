...
export default function Events() {
  ...
  if (!isLoading && searchParams && !selectedEvent && searchParams.get("eventId") !== null) msg = "invalid event id";

  if (msg !== null) {
    return <div className="container-height grid place-items-center">{msg}</div>;
  }
  ...
  return (
    <div className="container-height">
      ...
      {
        !selectedEvent ? <div className="grid h-4/6 place-items-center">No Event Selected</div> : <EventTable event={selectedEvent} />
      }
    </div>
  );
}